...
CONFIG_PATH = "/opt/airflow/dags/data_parser/oil_futures_parser/oil_futures_parser.yaml"
...
def fetch_assets_from_group(group_name):
    ...
    with engine.begin() as conn:
        conn.execute("CREATE SCHEMA IF NOT EXISTS oil_futures")
